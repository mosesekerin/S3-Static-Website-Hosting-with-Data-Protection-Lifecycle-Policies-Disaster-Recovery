...
This project demonstrates how to host, secure, and manage a static website for a small café business using **Amazon S3**.
...
The website showcases the café’s services while implementing **AWS best practices** for data protection, lifecycle management, and disaster recovery (DR).
...
### ✔ **2. Protect Data Using Amazon S3**
...
### ✔ **3. Implement a Data Lifecycle Strategy**
...
### ✔ **4. Set Up a Disaster Recovery Strategy**
...
```
[Local Files] → [S3 Bucket (Static Website)] → [Public Website]
...
5. Visitors access the café’s website via the S3 website endpoint.
